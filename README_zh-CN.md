...
- [ ] 完整 RFC 9002 丢包检测与拥塞控制（含 socket-owned protected-packet loss/PTO timer lifecycle 集成与剩余 NewReno 细节）
- [ ] TLS 1.3 集成（RFC 9001）
