...
- [CRYPTO streams](examples/crypto_stream.zig)：按 packet number space 隔离的 CRYPTO buffering、mock backend handoff、backend transport-parameter auto-close 和 protected CRYPTO flow。
