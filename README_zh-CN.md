...
- [UDP endpoint loopback](examples/udp_endpoint_loopback.zig)：socket-backed endpoint routing，覆盖 Version Negotiation、protected follow-up Initial、follow-up Original DCID 证据、accepted protected Initial processing、protected server Initial response processing、server transport-parameter validation 和 Initial/short-header classification。
