...
- [UDP address validation loopback](examples/udp_address_validation_loopback.zig)：socket-backed lifecycle-routed HANDSHAKE_DONE/NEW_TOKEN delivery、NEW_TOKEN path/version binding、replay snapshot restore rejection 和 future address-validation unblocking。
