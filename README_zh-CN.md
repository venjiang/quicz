...
- [UDP 0-RTT loopback](examples/udp_zero_rtt_loopback.zig)：socket-backed lifecycle-routed installed-key 0-RTT STREAM delivery、accept-before-process enforcement、accepted early ACK 证据、1-RTT ACK cleanup 和 client/server 0-RTT key discard 证据。
