...
- [x] 简化 RFC 9002 风格 ACK、loss、PTO、NewReno congestion、congestion-window 发送预算/满窗口/send-admission 查询、ECN、retransmission 和 endpoint recovery-timer 模型，并有 socket-backed UDP loopback 覆盖。
