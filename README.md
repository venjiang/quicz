...
PTO-recovery including Application PTO gating until handshake confirmation, client Initial ACK PTO-backoff reset suppression, connection-level PTO backoff, and cross-space peer probes, path-validation, address-validation including token version binding, Retry-token processing and v1/v2 integrity-tag,
