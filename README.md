...
PTO-recovery including cross-space peer probes, path-validation, address-validation including token version binding, Retry-token processing and v1/v2 integrity-tag,
