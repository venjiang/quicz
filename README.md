...
- [ ] Full RFC 9002 loss detection & congestion control with endpoint-owned protected-packet loss/PTO timer integration and remaining NewReno details
...
pub fn main() !void {
    ...
    // timer by applying due loss-time deadlines or PTO probing. Direct
    // checkLossDetectionTimeouts() and checkPtoTimeouts() remain available for
    // tests that need to service those paths separately; ACK_ECN uses the ACK
