...
pub fn main() !void {
    ...
    // checkPtoTimeouts() prefers queued ack-eliciting data, in-flight CRYPTO data, or in-flight STREAM data as PTO probes, otherwise queues packet-number-space PTO PING probes under a controlled clock; ACK_ECN uses the ACK
