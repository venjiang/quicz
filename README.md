...
- [x] Simplified RFC 9002-style ACK, loss, PTO, NewReno congestion, congestion-window and ack-eliciting send-admission budget queries, ECN, retransmission, and endpoint recovery-timer models with socket-backed UDP loopback coverage.
