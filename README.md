...
- [x] RFC 9000/RFC 9368 transport error code helpers, including fixed codes, VERSION_NEGOTIATION_ERROR, CRYPTO_ERROR TLS alert mapping, transport-parameter codec error classification to TRANSPORT_PARAMETER_ERROR, frame codec error classification to FRAME_ENCODING_ERROR, and frame packet-type violation classification to PROTOCOL_VIOLATION
