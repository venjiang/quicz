...
loss-recovery including invalid ACK range rejection, ACK-delay, NewReno underutilized-cwnd suppression, slow-start/congestion-avoidance byte-counted and batched-ACK growth, endpoint-timer-driven loss/PTO service with closing/draining disarm, recovery-period, minimum-window ssthresh clamp, ACK_ECN CE response, and persistent congestion handling,
