...
- [x] Simplified RFC 9002-style ACK, loss, PTO, NewReno congestion, congestion-window send-budget/full-window/send-admission queries, ECN, retransmission, and endpoint recovery-timer models with socket-backed UDP loopback coverage.
