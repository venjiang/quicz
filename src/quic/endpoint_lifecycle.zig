...
pub const EndpointConnectionLifecycle = struct {
    ...
    /// idle/close cleanup did not retire any connection.
    pub fn feedDatagramWithInstalledKeysAcrossConnectionsAndProcessPendingWorkAndDriveCryptoBackendsInSpaceWithCompatibleVersionAndPollDatagram(
        self: *EndpointConnectionLifecycle,
        receive_connections: []const EndpointConnectionReceiveView,
        path: endpoint.Udp4Tuple,
        now_millis: i64,
        ...
        if (pending_work.idle_retired_count == 0 and pending_work.close_retired_count == 0) {
            switch (feed) {
                .routed => backend = try self.driveCryptoBackendsInSpaceWithCompatibleVersionAndPollDatagram(
                    backend_space,
                    drive_views,
                    compatibilities,
                    poll_views,
    ...
    /// Peer Version Information errors queue CONNECTION_CLOSE and return before
    /// output polling.
    pub fn feedDatagramWithInstalledKeysAcrossConnectionsAndProcessPendingWorkAndDriveCryptoBackendsInSpaceWithCompatibleVersionOrCloseAndPollDatagram(
        self: *EndpointConnectionLifecycle,
        receive_connections: []const EndpointConnectionReceiveView,
        path: endpoint.Udp4Tuple,
        now_millis: i64,
        ...
        if (pending_work.idle_retired_count == 0 and pending_work.close_retired_count == 0) {
            switch (feed) {
                .routed => backend = try self.driveCryptoBackendsInSpaceWithCompatibleVersionOrCloseAndPollDatagram(
                    backend_space,
                    drive_views,
                    compatibilities,
                    poll_views,
    ...
    /// `feedDatagramWithInstalledKeysAcrossConnectionsAndProcessPendingWorkAndDriveCryptoBackendsInSpaceWithCompatibleVersionAndPollDatagram()`.
    pub fn feedDatagramWithInstalledKeysAcrossConnectionsAndProcessPendingWorkAndDriveCryptoBackendsInSpaceWithCompatibleVersionAndDrainDatagrams(
        self: *EndpointConnectionLifecycle,
        receive_connections: []const EndpointConnectionReceiveView,
        path: endpoint.Udp4Tuple,
        now_millis: i64,
        ...
        if (pending_work.idle_retired_count == 0 and pending_work.close_retired_count == 0) {
            switch (feed) {
                .routed => backend = try self.driveCryptoBackendsInSpaceWithCompatibleVersionAndDrainDatagrams(
                    backend_space,
                    drive_views,
                    compatibilities,
                    poll_views,
    ...
    /// Peer Version Information errors queue CONNECTION_CLOSE and return before
    /// output draining.
    pub fn feedDatagramWithInstalledKeysAcrossConnectionsAndProcessPendingWorkAndDriveCryptoBackendsInSpaceWithCompatibleVersionOrCloseAndDrainDatagrams(
        self: *EndpointConnectionLifecycle,
        receive_connections: []const EndpointConnectionReceiveView,
        path: endpoint.Udp4Tuple,
        now_millis: i64,
        ...
        if (pending_work.idle_retired_count == 0 and pending_work.close_retired_count == 0) {
            switch (feed) {
                .routed => backend = try self.driveCryptoBackendsInSpaceWithCompatibleVersionOrCloseAndDrainDatagrams(
                    backend_space,
                    drive_views,
                    compatibilities,
                    poll_views,
    ...
    pub fn feedDatagramWithInstalledKeysAcrossConnectionsAndProcessPendingWorkAndDriveCryptoBackendsAcrossSpacesAndPollDatagram(
        ...
        if (pending_work.idle_retired_count == 0 and pending_work.close_retired_count == 0) {
            switch (feed) {
                .routed => backend = try self.driveCryptoBackendsAcrossSpacesAndPollDatagram(
                    backend_spaces,
                    drive_views,
                    poll_views,
                    now_millis,
    ...
    pub fn feedDatagramWithInstalledKeysAcrossConnectionsAndProcessPendingWorkAndDriveCryptoBackendsInSpaceOrCloseAndPollDatagram(
        ...
        if (pending_work.idle_retired_count == 0 and pending_work.close_retired_count == 0) {
            switch (feed) {
                .routed => backend = try self.driveCryptoBackendsInSpaceOrCloseAndPollDatagram(
                    backend_space,
                    drive_views,
                    poll_views,
                    now_millis,
    ...
    pub fn feedDatagramWithInstalledKeysAcrossConnectionsAndProcessPendingWorkAndDriveCryptoBackendsAcrossSpacesAndDrainDatagrams(
        ...
        if (pending_work.idle_retired_count == 0 and pending_work.close_retired_count == 0) {
            switch (feed) {
                .routed => backend = try self.driveCryptoBackendsAcrossSpacesAndDrainDatagrams(
                    backend_spaces,
                    drive_views,
                    poll_views,
                    now_millis,
    ...
    pub fn feedDatagramWithInstalledKeysAcrossConnectionsAndProcessPendingWorkAndDriveCryptoBackendsInSpaceAndDrainDatagrams(
        ...
        if (pending_work.idle_retired_count == 0 and pending_work.close_retired_count == 0) {
            switch (feed) {
                .routed => backend = try self.driveCryptoBackendsInSpaceAndDrainDatagrams(
                    backend_space,
                    drive_views,
                    poll_views,
                    now_millis,
    ...
    pub fn feedDatagramWithInstalledKeysAcrossConnectionsAndProcessPendingWorkAndDriveCryptoBackendsInSpaceOrCloseAndDrainDatagrams(
        self: *EndpointConnectionLifecycle,
        receive_connections: []const EndpointConnectionReceiveView,
        path: endpoint.Udp4Tuple,
        now_millis: i64,
        ...
        if (pending_work.idle_retired_count == 0 and pending_work.close_retired_count == 0) {
            switch (feed) {
                .routed => backend = try self.driveCryptoBackendsInSpaceOrCloseAndDrainDatagrams(
                    backend_space,
                    drive_views,
                    poll_views,
                    now_millis,
    ...
    pub fn feedDatagramWithInstalledKeysAcrossConnectionsAndDriveCryptoBackendsInSpaceAndPollDatagramWithInstalledKeyOptions(
        ...
        return .{
            .feed = feed,
            .backend = try self.driveCryptoBackendsInSpaceAndPollDatagramWithInstalledKeyOptions(
                backend_space,
                drive_views,
                poll_views,
                now_millis,
    ...
    pub fn feedDatagramWithInstalledKeysAcrossConnectionsAndDriveCryptoBackendsInSpaceAndDrainDatagramsWithInstalledKeyOptions(
        ...
        return .{
            .feed = feed,
            .backend = try self.driveCryptoBackendsInSpaceAndDrainDatagramsWithInstalledKeyOptions(
                backend_space,
                drive_views,
                poll_views,
                now_millis,
    ...
    ///
    /// This is the socket-loop step for TLS backend progress that may queue
    /// protected CRYPTO or install keys and make already queued data sendable.
    /// Connection/backend storage and output ordering remain caller-owned via
    /// the two view slices.
    pub fn driveCryptoBackendsInSpaceAndPollDatagram(
        self: *EndpointConnectionLifecycle,
        space: PacketNumberSpace,
        drive_views: []const EndpointCryptoBackendDriveView,
        poll_views: []const EndpointConnectionPollView,
    ...
    pub fn driveCryptoBackendsAcrossSpacesOrCloseAndPollDatagram(
        self: *EndpointConnectionLifecycle,
        spaces: []const PacketNumberSpace,
        drive_views: []const EndpointCryptoBackendDriveView,
        poll_views: []const EndpointConnectionPollView,
    ...
    ///
    /// This is the caller-owned connection map form for backend sweep loops
    /// that need each connection to retain its own installed-key output choice.
    pub fn driveCryptoBackendsInSpaceAndPollDatagramWithInstalledKeyOptions(
        self: *EndpointConnectionLifecycle,
        space: PacketNumberSpace,
        drive_views: []const EndpointCryptoBackendDriveView,
        poll_views: []const EndpointConnectionInstalledKeyPollView,
    ...
    pub fn driveCryptoBackendInSpaceAndPollDatagram(
        ...
        return self.driveCryptoBackendsInSpaceAndPollDatagram(
            space,
            &drive_views,
            &poll_views,
            now_millis,
    ...
    /// final datagram queue. Backend progress is applied before draining, and
    /// the caller-provided output slice limits work for the current iteration.
    pub fn driveCryptoBackendsInSpaceAndDrainDatagrams(
        self: *EndpointConnectionLifecycle,
        space: PacketNumberSpace,
        drive_views: []const EndpointCryptoBackendDriveView,
        poll_views: []const EndpointConnectionPollView,
    ...
    /// Drive crypto backends, then drain installed-key output with explicit options.
    ///
    /// This is the bounded-output form of
    /// `driveCryptoBackendsInSpaceAndPollDatagramWithInstalledKeyOptions()`.
    pub fn driveCryptoBackendsInSpaceAndDrainDatagramsWithInstalledKeyOptions(
        self: *EndpointConnectionLifecycle,
        space: PacketNumberSpace,
        drive_views: []const EndpointCryptoBackendDriveView,
        poll_views: []const EndpointConnectionInstalledKeyPollView,
    ...
    pub fn driveCryptoBackendInSpaceAndDrainDatagrams(
        ...
        return self.driveCryptoBackendsInSpaceAndDrainDatagrams(
            space,
            &drive_views,
            &poll_views,
            now_millis,
    ...
    ///
    /// If backend peer transport-parameter processing fails, this returns that
    /// connection error before polling output so callers can surface the close
    /// path for the originating connection.
    pub fn driveCryptoBackendsInSpaceOrCloseAndPollDatagram(
        self: *EndpointConnectionLifecycle,
        space: PacketNumberSpace,
        drive_views: []const EndpointCryptoBackendDriveView,
        poll_views: []const EndpointConnectionPollView,
    ...
    /// Drive close-propagating crypto backends, then poll explicit output.
    ///
    /// Backend peer transport-parameter errors return before installed-key
    /// polling. Successful backend progress preserves each caller-owned
    /// connection's output options for the final poll step.
    pub fn driveCryptoBackendsInSpaceOrCloseAndPollDatagramWithInstalledKeyOptions(
        self: *EndpointConnectionLifecycle,
        space: PacketNumberSpace,
        drive_views: []const EndpointCryptoBackendDriveView,
        poll_views: []const EndpointConnectionInstalledKeyPollView,
    ...
    pub fn driveCryptoBackendInSpaceOrCloseAndPollDatagram(
        ...
        return self.driveCryptoBackendsInSpaceOrCloseAndPollDatagram(
            space,
            &drive_views,
            &poll_views,
            now_millis,
    ...
    pub fn driveCryptoBackendsAcrossSpacesWithCompatibleVersionAndPollDatagram(
        self: *EndpointConnectionLifecycle,
        spaces: []const PacketNumberSpace,
        drive_views: []const EndpointCryptoBackendDriveView,
        compatibilities: []const VersionCompatibility,
    ...
    pub fn driveCryptoBackendsAcrossSpacesWithCompatibleVersionAndDrainDatagrams(
        self: *EndpointConnectionLifecycle,
        spaces: []const PacketNumberSpace,
        drive_views: []const EndpointCryptoBackendDriveView,
        compatibilities: []const VersionCompatibility,
    ...
    pub fn driveCryptoBackendsAcrossSpacesWithCompatibleVersionOrCloseAndPollDatagramWithInstalledKeyOptions(
        self: *EndpointConnectionLifecycle,
        spaces: []const PacketNumberSpace,
        drive_views: []const EndpointCryptoBackendDriveView,
        compatibilities: []const VersionCompatibility,
    ...
    /// Drive one compatible-version close-propagating backend across ordered
    /// packet number spaces, then poll installed-key output.
    pub fn driveCryptoBackendAcrossSpacesWithCompatibleVersionOrCloseAndPollDatagram(
        self: *EndpointConnectionLifecycle,
        connection_id: u64,
        connection: *Connection,
        spaces: []const PacketNumberSpace,
        ...
        return self.driveCryptoBackendsAcrossSpacesWithCompatibleVersionOrCloseAndPollDatagram(
            spaces,
            &drive_views,
            compatibilities,
            &poll_views,
    ...
    /// Process pending work, drive close-propagating crypto backends across
    /// ordered packet number spaces, then poll explicit output.
    ///
    /// This is the close-on-error form of
    /// `processPendingWorkAcrossConnectionsAndDriveCryptoBackendsAcrossSpacesAndPollDatagramWithInstalledKeyOptions()`.
    pub fn processPendingWorkAcrossConnectionsAndDriveCryptoBackendsAcrossSpacesOrCloseAndPollDatagramWithInstalledKeyOptions(
        self: *EndpointConnectionLifecycle,
        pending_connections: []const EndpointConnectionReceiveView,
        now_millis: i64,
        backend_spaces: []const PacketNumberSpace,
    ...
    /// Process pending work, drive close-propagating crypto backends across
    /// ordered packet number spaces, then drain output.
    ///
    /// This is the bounded-output form of
    /// `processPendingWorkAcrossConnectionsAndDriveCryptoBackendsAcrossSpacesOrCloseAndPollDatagram()`.
    pub fn processPendingWorkAcrossConnectionsAndDriveCryptoBackendsAcrossSpacesOrCloseAndDrainDatagrams(
        self: *EndpointConnectionLifecycle,
        pending_connections: []const EndpointConnectionReceiveView,
        now_millis: i64,
        backend_spaces: []const PacketNumberSpace,
    ...
    /// Process one due deadline, drive one backend across ordered packet number
    /// spaces, then select a deadline.
    ///
    /// This is the cross-space form of
    /// `processDueDeadlineAndDriveCryptoBackendInSpaceAndSelectNextDeadline()`.
    pub fn processDueDeadlineAndDriveCryptoBackendAcrossSpacesAndSelectNextDeadline(
        self: *EndpointConnectionLifecycle,
        connection_id: u64,
        connection: *Connection,
        now_millis: i64,
    ...
    /// terminal idle/close deadline stops before backend progress because the
    /// selected caller-owned connection is no longer live. Recovery and other
    /// live due work continue into backend drive, and the backend result carries
    /// the final post-backend wakeup.
    ...
    /// number spaces, then select the next deadline.
    ///
    /// This is the cross-space form of
    /// `processDueDeadlineAcrossConnectionsAndDriveCryptoBackendsInSpaceAndSelectNextDeadline()`.
    ...
    ///
    /// This is the RFC 9368-compatible no-output form of the due-deadline
    /// backend planning step. Terminal idle/close deadlines stop before backend
    /// progress; live due work continues into compatible-version backend drive
    /// before the lifecycle recomputes the next endpoint-visible wakeup.
    ...
    /// due-deadline backend planning step. Terminal idle/close deadlines stop
    /// before backend progress. Live due work continues into the compatible
    /// OrClose backend sweep, where peer Version Information errors queue
    ...
    /// close-propagating TLS backends across ordered packet number spaces.
    ///
    /// This is the cross-space form of
    /// `processDueDeadlineAcrossConnectionsAndDriveCryptoBackendsInSpaceOrCloseAndPollDatagramWithInstalledKeyOptions()`.
    pub fn processDueDeadlineAcrossConnectionsAndDriveCryptoBackendsAcrossSpacesOrCloseAndPollDatagramWithInstalledKeyOptions(
        self: *EndpointConnectionLifecycle,
        deadline_connections: []const EndpointConnectionInstalledKeyPollView,
        now_millis: i64,
        backend_spaces: []const PacketNumberSpace,
    ...
    pub fn processDueDeadlineAcrossConnectionsAndDriveCryptoBackendsAcrossSpacesOrCloseAndDrainDatagrams(
        self: *EndpointConnectionLifecycle,
        deadline_connections: []const EndpointConnectionPollView,
        now_millis: i64,
        backend_spaces: []const PacketNumberSpace,
    ...
    /// Process caller-owned key-phase 1-RTT input with close propagation and select a wakeup.
    ///
    ...
    /// wakeup selection.
    pub fn processProtectedShortDatagramWithKeyPhaseStateOrCloseAndSelectNextDeadline(
        self: *EndpointConnectionLifecycle,
        connection_id: u64,
        connection: *Connection,
        now_millis: i64,
    ...
    pub fn processProtectedHandshakeDatagramWithInstalledKeysAndDriveCryptoBackendAndDrainDatagrams(
        ...
        return try self.driveCryptoBackendsInSpaceAndDrainDatagrams(
            .handshake,
            &drive_views,
            &poll_views,
            now_millis,
    ...
    /// Process one installed-key 1-RTT datagram with close propagation and select a wakeup.
    ///
    /// Authenticated frame-payload errors queue CONNECTION_CLOSE and return
    /// before wakeup selection. Successful receive uses the same no-output
    /// scheduling contract as the non-close-propagating path.
    pub fn processProtectedShortDatagramWithInstalledKeysOrCloseAndSelectNextDeadline(
        self: *EndpointConnectionLifecycle,
        connection_id: u64,
        connection: *Connection,
        now_millis: i64,
    ...
    ///
    /// Authenticated Application frame errors or backend peer-parameter errors
    /// queue CONNECTION_CLOSE and return before ordinary bounded output
    ...
    /// output after a failed receive step.
    ...
    ///
    /// Authenticated frame-payload errors queue CONNECTION_CLOSE and return
    /// before any caller-selected installed-key output is drained.
