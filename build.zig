...
pub fn build(b: *std.Build) void {
    ...
    const run_interop_event_loopback = b.step("run-interop-event-loopback", "Run event-driven interop loopback (TESTCASE: handshake/transfer/loss/congestion/persistent/key-update)");
