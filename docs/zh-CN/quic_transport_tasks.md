...
- 2026-06-05：扩展 `examples/tls_openssl_backend_adapter.zig`，让 server
  ...
  `server_connection_initial=1511/1184/1223/1184/43/true/8/true`，依次证明 server
  ...
  key 安装、允许的 8 条 peer-limited bidirectional streams，以及第 9 次 open 被阻塞。
  示例也会打印
