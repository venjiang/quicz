...
| P0-B1 | Protected bidi/uni stream data | RFC 9000 Sections 2、4、19.8 | Endpoint 后面的 `Connection` stream state | Bidi 和 uni data plus FIN 能跑在 protected endpoint packet 上。 | Active |
...
| 3 | P0-B1 protected bidi/uni stream data | Active | 增加 endpoint-level bidi/uni data 与 FIN 覆盖；只修这条证据需要的 stream/endpoint 代码。 |
