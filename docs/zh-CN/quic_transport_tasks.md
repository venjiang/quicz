...
- 2026-05-22：在 `QuicConnection` 增加本端 connection ID 签发。
  ...
  socket-backed replacement-CID route-retirement 证明现在位于
  `examples/udp_replacement_cid_loopback.zig`，完整 connection lifecycle wiring 和
  socket 拥有的替换策略仍待实现。
