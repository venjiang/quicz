...
- 2026-06-04：扩展 `examples/tls_openssl_backend_adapter.zig`，让
  ...
  pair transcript，并会验证安装后的 1-RTT keys 可以保护 short packet；完整对端
  transcript 驱动仍待实现。
