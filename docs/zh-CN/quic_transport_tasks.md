...
- 2026-06-04：扩展 `examples/tls_openssl_backend_adapter.zig`，让
  ...
  socket/lifecycle loop owner；示例会打印 `peer_tp_bytes=31` 和 `transcript_tp=31`
  证明连接层应用的 peer bytes 来自 pair transcript，也会打印 `transcript_keylog=5/5/773/773`
