...
- 实体iPhone 14 Pro中的Swift基准已通过同一XCFramework C ABI连接Host listener，完成证书校验、100轮8字节串行回显、关闭和Host连接状态回收；一次Debug Wi-Fi样本为handshake 3030.383毫秒、RTT p50/p95/p99分别为11.810/15.769/19.374毫秒。
