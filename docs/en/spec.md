...
- Implemented: QUIC varint helpers, minimal long/short header codecs, and basic frame codecs for STREAM, CRYPTO, PADDING, PING, ACK with additional ranges, RESET_STREAM, STOP_SENDING, MAX_DATA, MAX_STREAM_DATA, MAX_STREAMS_BIDI/UNI, DATA_BLOCKED, STREAM_DATA_BLOCKED, STREAMS_BLOCKED_BIDI/UNI, NEW_TOKEN, NEW_CONNECTION_ID, RETIRE_CONNECTION_ID, PATH_CHALLENGE/PATH_RESPONSE, and connection-close variants.
