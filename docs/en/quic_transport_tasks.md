...
empty certificate entries, oversized configured certificate chains, plus
missing, short, or otherwise invalid configured private keys before committing
parsed peer state or queuing/emitting ServerHello. Pure-Zig TLS client-side
ServerHello parsing now also
