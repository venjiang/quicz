...
- 2026-06-04: Extended `examples/tls_openssl_backend_adapter.zig` so the
  ...
  the example prints `adapter_pto=62/53/511/1` for PTO deadline, PTO datagram
