...
PTO probe, ALPN selection validation, SNI validation, ClientHello extension validation, duplicate-extension rejection, and recovery-timer service — all without
