...
- 2026-05-27: Added aggregate RFC 9002 loss detection timer service.
  ...
  deadlines through the aggregate helper. Remaining work is endpoint-owned
  protected-packet loss/PTO timer integration and remaining NewReno details.
- 2026-05-27: Added protected 0-RTT RESET_STREAM/STOP_SENDING retransmission
  ...
  STOP_SENDING retransmission demonstration. Remaining work is endpoint-owned
  protected-packet loss/PTO timer integration and remaining NewReno details.
- 2026-05-27: Added protected 0-RTT STREAM retransmission coverage. Successful
  ...
  RESET_STREAM/STOP_SENDING retransmission; remaining work is endpoint-owned
  protected-packet loss/PTO timer integration and remaining NewReno details.
- 2026-05-26: Added ACK-driven frame-payload CRYPTO retransmission requeue.
  ...
  loss/PTO timer deadline selection. Remaining work is endpoint-owned
  protected-packet timer integration.
- 2026-05-26: Extended the PTO probe hook to reuse in-flight Application
  ...
  endpoint-owned protected-packet timer integration remains pending.
...
- 2026-05-22: Added RFC 9002 time-threshold loss delay calculation,
  ...
  retransmission and aggregate timer deadline selection; endpoint-owned
  protected-packet timer integration remains pending.
...
| `udp_ecn_validation_loopback` | Socket-backed loopback UDP ECN validation exercise: modeled ECT(0) protected short PING routing, protected ACK_ECN success, endpoint ECN state update for the active UDP tuple, and migrated-path ECN isolation without claiming real IP-header ECN marking. | Present |
| `udp_loss_recovery_loopback` | Socket-backed loopback UDP loss-recovery exercise: protected short PING routing, protected ACK-driven packet-threshold loss, and aggregate-service-driven time-threshold cleanup. | Present |
...
| `udp_pto_recovery_loopback` | Socket-backed loopback UDP PTO recovery exercise: aggregate-service-driven ACK-loss PTO deadline, protected PING fallback probe delivery, queued STREAM data as a protected PTO probe, in-flight STREAM/CRYPTO data as protected PTO probes, duplicate receive/CRYPTO range discard, and final ACK cleanup. | Present |
...
| `loss_recovery` | Current frame-payload packet-threshold loss, time-threshold loss, aggregate loss-time timer service, NewReno recovery period, persistent congestion, and ACK-delay handling. | Present |
