...
- 2026-06-05: Added `examples/tls_openssl_pair_transcript.zig` plus a small C
  ...
  parses those peer transport-parameter bytes, records keylog callback
...
- 2026-06-04: Extended `examples/tls_openssl_backend_adapter.zig` so the
  ...
  the example prints `transcript_tp=6` for pair-transcript peer
  transport-parameter bytes, `transcript_keylog=5/5/773/773` for the full
  OpenSSL pair transcript, and `adapter_keylog=0/0` for the current
