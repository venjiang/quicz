...
- 2026-07-16: Added a routed datagram dispatcher to `Tls13ServerEndpoint`.
  ...
  processing routed long/short packets behind the endpoint owner. Tests cover
  routed Initial, Handshake, short-packet dispatch, and non-routed Version
  Negotiation without editing examples.
