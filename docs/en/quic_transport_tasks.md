...
| P0-C1 | ACK and RTT accounting | RFC 9000 ACK; RFC 9002 RTT and outstanding packet state | Recovery and ACK receive path | ACK cleanup updates outstanding packets, RTT samples, bytes-in-flight, and ack-eliciting state. | Active |
...
| 6 | P0-C1 ACK/RTT accounting | Active | Close ACK cleanup, RTT, outstanding packet, and bytes-in-flight evidence at the endpoint seam. |
