...
the complete state.
NewSessionTicket parsing now rejects duplicate extension types, including
duplicate unknown extensions, before deriving or storing resumption PSKs for a
later ClientHello.
