...
| P3-H | Multipath | MultipathManager: path state, abandon, status, validation, RTT-based selection; 6 tests | Multi-path handshake and data transfer tests; connection integration pending | Active |
