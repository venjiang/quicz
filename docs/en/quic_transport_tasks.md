...
- 2026-07-16: Added a routed datagram dispatcher to `Tls13ServerEndpoint`.
  ...
  through the existing route-bound processing path. Tests cover routed Initial,
  Handshake, and short-packet dispatch without editing examples.
