...
- 2026-05-22: Added `examples/codec_roundtrip.zig` and `zig build run-codec`.
  ...
  helper roundtrips including frame codec and packet-type error classification.
