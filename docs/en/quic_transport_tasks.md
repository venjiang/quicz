...
- 2026-06-05: Extended `examples/tls_openssl_backend_adapter.zig` so the server
  ...
  server Handshake keys. Full endpoint-owned live TLS handshake/socket loop
  remains pending.
