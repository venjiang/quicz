...
| `endpoint_recovery_timers` | Endpoint-owned recovery timer scheduling across caller-owned connection handles: endpoint lifecycle route ownership, earliest aggregate timer selection, before-deadline no-op refresh, PTO service/re-arm, ACK-driven disarm, loss-time service, final timer disarm, connection-handle route retirement, protected long-header send/receive timer refresh, routed caller-keyed Handshake CRYPTO-space and 0-RTT long-packet receive timer refresh, caller-keyed Initial/Handshake CRYPTO-space and 0-RTT long-packet send timer refresh, caller-keyed protected 1-RTT short-packet send/receive timer refresh, explicit key-phase/key-update short-packet timer refresh, caller-owned key-phase-state short-packet send/receive timer refresh, routed installed-key Handshake/0-RTT long-packet receive timer refresh, installed-key Handshake/0-RTT long-packet send timer refresh, and installed-key protected 1-RTT short-packet send/receive timer refresh. | Present |
