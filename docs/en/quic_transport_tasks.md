...
- 2026-06-18: Split QUIC wire-length budgeting helpers into
  ...
  packet-number lengths, long-packet payload overflow rejection, Initial/short
  datagram minimum-length expansion, and STREAM/CRYPTO payload sizing across
  varint length expansion to keep send-path budgeting behavior unchanged.
