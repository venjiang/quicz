...
- 2026-06-04: Extended `examples/tls_openssl_backend_adapter.zig` so the
  ...
  the example prints `peer_tp_bytes=31` and `transcript_tp=31` to show that the
  connection-applied peer bytes came from the pair transcript, prints
