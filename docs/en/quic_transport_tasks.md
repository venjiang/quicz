...
- 2026-06-04: Extended `examples/tls_openssl_backend_adapter.zig` so the
  ...
  inbound CRYPTO through OpenSSL callback boundaries, verifies the installed
  1-RTT keys can protect a short packet, and intentionally leaves full peer
