...
PTO probe, ALPN selection validation, SNI validation, ClientHello extension validation, duplicate-extension rejection, PSK/early-data validation, and recovery-timer service — all without
