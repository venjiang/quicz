...
NewSessionTicket construction now also requires derived Application traffic
secrets, preventing resumption PSK derivation from an uninitialized master
secret even if a server state is incorrectly marked connected.
