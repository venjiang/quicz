...
driving runs as one lifecycle operation for accepted Initial follow-up Handshake output, Retry follow-up, coalesced, and routed Initial plus Handshake input,
