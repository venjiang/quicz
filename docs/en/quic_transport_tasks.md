...
Pure-Zig TLS client-side EncryptedExtensions parsing now rejects empty ALPN
protocol entries without committing negotiated ALPN, peer transport parameters,
transcript, or handshake state.
