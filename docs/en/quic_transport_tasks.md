...
| `graceful_close` | Current in-memory and caller-keyed protected short CONNECTION_CLOSE/APPLICATION_CLOSE send/receive, peer close diagnostics, invalid frame-payload auto-close, retransmission, and closing/draining state behavior. | Present |
