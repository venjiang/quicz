...
- 2026-05-22: Added local connection ID issuing in `QuicConnection`.
  ...
  socket-backed replacement-CID route-retirement proof now lives in
  `examples/udp_replacement_cid_loopback.zig`, while full connection lifecycle
