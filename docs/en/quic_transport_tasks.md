...
| RFC 9002 loss detection and congestion control | Partial | ACK delay scaling/capping, packet/time-threshold loss, ACK-driven frame-payload STREAM/CRYPTO, protected CRYPTO, and protected 0-RTT STREAM/RESET_STREAM/STOP_SENDING retransmission requeue, NewReno recovery-period behavior, persistent congestion, packet-space PTO PING/new-data/in-flight-CRYPTO/protected-0-RTT-control/protected-0-RTT-STREAM/in-flight-STREAM probe hooks with Initial/Handshake max_ack_delay suppression, ECN validation tests, and socket-backed UDP loss-recovery/congestion-recovery/PTO-recovery/STREAM-retransmission loopbacks. | Full protected-packet PTO/loss timer scheduling and remaining NewReno details with controlled-clock tests. |
...
- 2026-05-27: Added protected 0-RTT RESET_STREAM/STOP_SENDING retransmission
  ...
  STOP_SENDING retransmission demonstration. Remaining work is full
  protected-packet PTO/loss timer scheduling and remaining NewReno details.
- 2026-05-27: Added protected 0-RTT STREAM retransmission coverage. Successful
  ...
  RESET_STREAM/STOP_SENDING retransmission; remaining work is full
  protected-packet PTO/loss timer scheduling and remaining NewReno details.
- 2026-05-26: Added ACK-driven frame-payload CRYPTO retransmission requeue.
  ...
  0-RTT STREAM/RESET_STREAM/STOP_SENDING retransmission. Remaining work is
  protected-packet timer scheduling.
- 2026-05-26: Extended the PTO probe hook to reuse in-flight Application
  ...
  retransmission are now covered; full protected-packet timer scheduling remains pending.
