...
| P5-C | Interop-Runner compat | Server+client binaries compile (Zig 0.16 adapted); Dockerfile + run_endpoint.sh ready | Docker build + interop-runner handshake/transfer test | Active (echo server verified, interop server adaptation pending) |
