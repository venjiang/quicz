...
- 2026-05-23: Added idempotent receive handling for duplicate STREAM
  ...
  prefix/suffix overlaps against pending ranges are trimmed, and pending-covered
  subranges are ignored without growing receive flow-control accounting.
  ...
  overlap trimming, conflicting overlap rejection, and rollback;
